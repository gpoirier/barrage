...
object lens {
  ...
  val contracts: Lens[PlayerState, Set[Contract]] = GenLens[PlayerState](_.contracts)
  ...
  val contractOffice: Lens[GameState, ContractOffice] = GenLens[GameState](_.contractOffice)
